...
We have deleted all self.Debug() statements to make the file look neat. For the version
with self.Debug() logs, pleaese refer to the algorithm shared on QuantConnect. 
'''
